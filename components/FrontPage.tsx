      ...
      <div className="md:flex md:justify-center md:items-center md:gap-8">
        <div className="lg:w-1/2">
          <div className="flex gap-2 md:flex-gap-4 px-4 pb-6">
            <h1 className="text-3xl md:text-6xl font-mono">Hi all, Im Sunil</h1>
            <img
          ...
          <div className="p-3 px-6 md:m-6 md:mx-12 flex gap-4">
            <a href="https://github.com/Sunilverma99">
              <div className="rounded-full w-6 h-6 md:w-12 md:h-12 bg-slate-600 text-white items-center justify-center p-1 md:p-2 hover:bg-black">
                <FaGithub className="w-4 h-4 md:w-8 md:h-8" />
              </div>
            </a>
            <a href="https://www.linkedin.com/in/sunil-verma-b7985024a/">
              <div className="rounded-full w-6 h-6 md:w-12 md:h-12 bg-blue-400 items-center justify-center p-1 md:p-2 hover:bg-black hover:text-white">
                <FaLinkedinIn className="w-4 h-4 md:w-8 md:h-8" />
              </div>
            </a>
            <a href="#contact">
              <div className="rounded-full w-6 h-6 md:w-12 md:h-12 bg-orange-500 text-white items-center justify-center p-1 md:p-2 hover:bg-black">
                <MdOutlineEmail className="w-4 h-4 md:w-8 md:h-8" />
              </div>
            </a>
            <a href="https://twitter.com/SunilVerma74513">
              <div className="rounded-full w-6 h-6 md:w-12 md:h-12 bg-gray-600 text-white items-center justify-center p-1 md:p-2 hover:bg-black">
